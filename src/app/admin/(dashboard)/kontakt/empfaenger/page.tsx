            ...
            {(state) => (
              <>
                ...
                <div className="grid gap-3 sm:grid-cols-3">
                  <Field label="E-Mail-Adresse" name="email" required error={state.fieldErrors?.email}>
              ...
              {(state) => (
                <>
                  <div className="grid gap-3 sm:grid-cols-2">
                    <Field label="Bezeichnung" name="label" required error={state.fieldErrors?.label}>
                      <input id="label" name="label" type="text" required maxLength={80} className="input" />
                    </Field>
                    <Field label="Schlüssel" name="key" required error={state.fieldErrors?.key} hint="Kleinbuchstaben, z. B. sponsoring.">
          ...
          <div className="space-y-6">
              ...
              <ActionForm action={saveTemplateAction} className="space-y-4">
                {(state) => (
                  <>
                    ...
                    <Field label="Betreff" name="subject" required error={state.fieldErrors?.subject}>
                      <input
                        id="subject"
                        name="subject"
                        type="text"
            ...
            <Panel title="Testmail" description="Prüft die SMTP-Verbindung und den Versandweg.">
              <ActionForm action={sendTestMailAction} className="space-y-4">
                {(state) => (
                  <>
                    <Field label="Empfänger" name="to" required error={state.fieldErrors?.to}>
